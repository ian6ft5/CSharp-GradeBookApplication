...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Create 'Name' 'Type' 'Weighted' - Creates a new gradebook where 'Name' is the name of the gradebook and 'Type' is what type of grading it should use, and 'Weighted' is whether or not the grades should be weighted (true or false).");
            Console.WriteLine();
